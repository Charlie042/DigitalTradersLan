  ...
  return (
    <section className="diff">
      <div className="diff-inner">
        <div className="eyebrow" style={{ color: 'rgba(255,255,255,0.4)', justifyContent: 'center' }}><span className="bar" style={{ background: 'rgba(255,255,255,0.4)' }}></span>Why DigitalTradersLab</div>
        <h2 className="section-h" style={{ color: 'var(--white)' }}>Built different.<br/><span style={{ color: 'var(--electric)' }}>On purpose.</span></h2>
        <p className="section-body" style={{ color: 'rgba(255,255,255,0.45)', maxWidth: '420px', margin: '0 auto' }}>We didn't copy what exists. We built the platform we wished existed when we were learning to trade.</p>
